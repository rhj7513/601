...
<body>
    <form name="frmData" id="frmData" method="post" action="StudentMain.jsp">
        <input type="text" name="name" id="name" value="È«±æµ¿" />
        <input type="text" name="id" id="id" value="gildong" />
    </form>
    
    <!-- <a href="#" onClick="openPop();">ÆË¾÷Ã¢À¸·Î POST Àü¼Û!!</a> -->
    
    <div id="login-box">
      <div class="left">
        <h1 id='status'>Login</h1>
            <div style="padding:10px 0px 10px 0px">
                <input type="radio" name="check" value="ÇÐ»ý" onClick="location.href='StudentLogin.html'" /> ÇÐ»ý
                <input type="radio" name="check" value="±³¼ö´Ô" onClick="location.href='ProfessorLogin.html'" /> ±³¼ö´Ô
            </div>
