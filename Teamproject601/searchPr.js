    ...
    $(document).ready(function() {
        ...
        for(var r=0; r<rows.length; r++ ){
            ...
            if(cell_1==searchPr) { //일치하는 교수 이름이 있으면 출력해주기
                ...
                $("#pro").append("<p class='pro1' class='fw-bold' style='color: white'>"+searchPr+"</p>");
                $("#major").append("<p class='major1'class='fw-bold' style='color: white'>컴퓨터공학부</p>");
                $("#bt").append("<p class='bt1'><button id='bt' type='button'class='btn btn-light' onclick=\"location.href=\'possiblePr.html\'\">click</button></p>");
